                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (form.validate() && verificaPasswordController.text == passwordController.text) {
                              print('aaaaaaaaaaaaaa');

                              await AuthServiceCadasto().registerUser(emailController.text, passwordController.text);
